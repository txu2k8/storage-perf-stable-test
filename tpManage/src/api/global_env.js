...
export function getGlobalEnvDetail(pk, params) {
  return request({
    url: '/api/base/global/env/detail/' + pk + '/',
    method: 'get',
    params
  })
}
...
export function updateGlobalEnv(pk, data) {
  return request({
    url: '/api/base/global/env/update/' + pk + '/',
    method: 'patch',
    data
  })
}
...
export function deleteGlobalEnv(pk) {
  return request({
    url: '/api/base/global/env/del/' + pk + '/',
    method: 'delete'
  })
}
...
export function getGlobalEnvData(pk, params) {
  return request({
    url: '/api/base/global/env/data/' + pk + '/',
    method: 'get',
    params
  })
}
...
export function getGlobalEnvConfigDefault(params) {
  return request({
    url: '/api/base/global/env/config/default',
    method: 'get',
    params
  })
}
...
export function getGlobalEnvQWExternalContactConfigDefault(params) {
  return request({
    url: '/api/base/global/env/qw_external_contact_config/default',
    method: 'get',
    params
  })
}
