...
export function getGlobalLabelList(params) {
  return request({
    url: '/api/base/global/label/list',
    method: 'get',
    params: params
  })
}
...
export function getGlobalLabelDetail(pk, params) {
  return request({
    url: '/api/base/global/label/detail/' + pk + '/',
    method: 'get',
    params
  })
}
...
export function updateGlobalLabel(pk, data) {
  return request({
    url: '/api/base/global/label/update/' + pk + '/',
    method: 'patch',
    data
  })
}
...
export function bulkUpdateGlobalLabel(dataArr) {
  return request({
    url: '/api/base/global/label/bulk/',
    method: 'patch',
    data: dataArr
  })
}
...
export function deleteGlobalLabel(pk) {
  return request({
    url: '/api/base/global/label/del/' + pk + '/',
    method: 'delete'
  })
}
