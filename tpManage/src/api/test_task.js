...
export function getTestTaskDetail(pk, params) {
  return request({
    url: '/api/base/test/task/detail/' + pk + '/',
    method: 'get',
    params
  })
}
...
export function updateTestTask(pk, data) {
  return request({
    url: '/api/base/test/task/update/' + pk + '/',
    method: 'patch',
    data
  })
}
