  ...
  <div class="main" style="padding:10px;">
    ...
    >
        ...
        <template slot-scope="scope">
          ...
          >
            <el-card class="box-card" shadow="never">
              ...
              <el-table :data="dictConfigToArray(scope.row.config, {})" style="width: 100%">
        ...
        <template slot-scope="scope">
          ...
          >
            <el-row>
              ...
              <el-button style="padding-left: 10px" type="primary" @click="toggleExpanded">{{ expanded ? '收起' : '展开' }}</el-button>
      ...
      <el-table-column prop="mock" label="Mock数据" min-width="100">
        <template slot-scope="scope">
          ...
          >
            <el-row>
              <el-button style="float: right;" type="text" @click="clearMock(scope.row)">清除数据</el-button>
              <el-button style="padding-left: 10px" type="primary" @click="toggleExpanded">{{ expanded ? '收起' : '展开' }}</el-button>
      ...
      <el-table-column label="操作" min-width="180">
        <template slot-scope="scope">
          <el-button type="info" icon="el-icon-edit" circle title="编辑" @click="handleEdit(scope.$index, scope.row)" />
          <el-button type="warning" icon="el-icon-refresh" circle title="更新环境数据" @click="handleUpdateEnvData(scope.$index, scope.row)" />
          <el-button type="warning" icon="el-icon-s-flag" circle :title="scope.row.status===false?'启用':'禁用'" @click="handleChangeStatus(scope.$index, scope.row)" />
          <el-button type="danger" icon="el-icon-delete" circle :loading="delLoading" title="删除" @click="handleDel(scope.$index, scope.row)" />
        </template>
      </el-table-column>
    </el-table>
    ...
    >
      <div class="demo-drawer__content">
        <el-form ref="editForm" :model="editForm" :rules="editFormRules" label-width="160px">
          <!--  基本信息  -->
          <el-collapse value="1">
