        ...
        <el-row :span="24">
          <el-col :span="14">
            <el-form-item label="所属项目" prop="type">
              <el-select v-model="editForm.project" value-key="id" style="min-width: 300px" placeholder="所属项目" filterable clearable>
    ...
    <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" style="width: 100%; left: 0">
      <el-form ref="addForm" :model="addForm" label-width="100px" :rules="addFormRules">
        ...
        <el-row :span="24">
          <el-col :span="14">
            <el-form-item label="所属项目" prop="type">
              <el-select v-model="addForm.project" value-key="id" style="min-width: 300px" placeholder="所属项目" filterable clearable>
                <el-option v-for="item in project_options" :key="item.id" :label="item.name" :value="item" />
              </el-select>
            </el-form-item>
          </el-col>
  ...
  data() {
    return {
      ...
      label_type_options: [
        ...
        { type: 'test_type', type_name: '测试类型' },
        { type: 'feature', type_name: '业务功能' },
        { type: 'case', type_name: '业务场景' },
        { type: 'diff', type_name: '对比测试' }
      ],
      filters: {
        name: '',
        type: ''
        ...
        if (valid) {
          this.$confirm('确认提交吗？', '提示', {}).then(() => {
            ...
            const params = {
              ...
              project_id: this.editForm.project.id,
